...
class binary:
    ...
    def runGA(self):
        ga = GA(self.pop_size,mutationRate=0.1,fitness=self.fitness_bits,individual_factory= self.sequence_bit_factory(),gene_factory=self.gen_factory(),termination_condition = lambda f : f == 0, silent =False,max_iter=10)
